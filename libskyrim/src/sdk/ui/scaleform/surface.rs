...
impl MenuSurface {
    ...
    #[inline(always)]
    fn with_movie_view<R>(
        &self,
        _caller: &'static str,
        f: impl FnOnce(&GFxMovieView) -> R,
    ) -> Option<R> {
        let Some(movie) = (unsafe { self.menu.ui_movie.as_ref() }) else {
            crate::defensive_sdk_warn!("{} skipped because the menu has no GFxMovieView", _caller);
            return None;
        };
    ...
    pub fn is_available_c_str(&self, path: &CStr) -> bool {
        self.with_movie_view(
            "sdk::ui::scaleform::MenuSurface::is_available_c_str()",
            |movie| movie.is_available(path.as_ptr()),
        )
        .unwrap_or(false)
    }
    ...
    pub fn is_available(&self, path: &str) -> Result<bool, NulError> {
        with_cstring(
            path,
            "sdk::ui::scaleform::MenuSurface::is_available()",
            |path| self.is_available_c_str(path),
        )
    }
    ...
    pub fn get_variable_c_str(&self, path: &CStr, value: &mut GFxValue) -> bool {
        self.with_movie_view(
            "sdk::ui::scaleform::MenuSurface::get_variable_c_str()",
            |movie| movie.get_variable(value, path.as_ptr()),
        )
        .unwrap_or(false)
    }
    ...
    pub fn get_variable(&self, path: &str, value: &mut GFxValue) -> Result<bool, NulError> {
        with_cstring(
            path,
            "sdk::ui::scaleform::MenuSurface::get_variable()",
            |path| self.get_variable_c_str(path, value),
        )
    }
    ...
    pub fn variable(&self, path: &str) -> Result<Option<GFxValue>, NulError> {
        with_cstring(
            path,
            "sdk::ui::scaleform::MenuSurface::variable()",
            |path| self.variable_c_str(path),
        )
    }
    ...
    pub fn set_variable_c_str(
        ...
        self.with_movie_view(
            "sdk::ui::scaleform::MenuSurface::set_variable_c_str()",
            |movie| movie.set_variable(path.as_ptr(), value, set_type),
        )
        .unwrap_or(false)
    }
    ...
    pub fn set_variable(
        ...
        with_cstring(
            path,
            "sdk::ui::scaleform::MenuSurface::set_variable()",
            |path| self.set_variable_c_str(path, value, set_type),
        )
    }
    ...
    pub fn set_variable_bool(
        ...
        with_cstring(
            path,
            "sdk::ui::scaleform::MenuSurface::set_variable_bool()",
            |path| self.set_variable_bool_c_str(path, value, set_type),
        )
    }
    ...
    pub fn set_variable_number(
        ...
        with_cstring(
            path,
            "sdk::ui::scaleform::MenuSurface::set_variable_number()",
            |path| self.set_variable_number_c_str(path, value, set_type),
        )
    }
    ...
    pub fn invoke_c_str(
        ...
        self.with_movie_view("sdk::ui::scaleform::MenuSurface::invoke_c_str()", |movie| {
            movie.invoke(
                method_name.as_ptr(),
    ...
    pub fn invoke(
        ...
        with_cstring(
            method_name,
            "sdk::ui::scaleform::MenuSurface::invoke()",
            |method_name| self.invoke_c_str(method_name, result, args),
        )
    }
    ...
    pub fn invoke_no_args(
        ...
        with_cstring(
            method_name,
            "sdk::ui::scaleform::MenuSurface::invoke_no_args()",
            |method_name| self.invoke_no_args_c_str(method_name, result),
        )
    }
    ...
    pub fn invoke_no_return_c_str(&self, method_name: &CStr, args: &[GFxValue]) -> bool {
        self.with_movie_view(
            "sdk::ui::scaleform::MenuSurface::invoke_no_return_c_str()",
            |movie| {
    ...
    pub fn invoke_no_return(&self, method_name: &str, args: &[GFxValue]) -> Result<bool, NulError> {
        with_cstring(
            method_name,
            "sdk::ui::scaleform::MenuSurface::invoke_no_return()",
            |method_name| self.invoke_no_return_c_str(method_name, args),
        )
    }
}
