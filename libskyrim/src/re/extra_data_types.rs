...
pub enum ExtraDataType {
    ...
    LeveledItem = 0x2E,
    Scale = 0x2F,
    MissingLinkedRefIDs = 0x30,
    MagicCaster = 0x31,
    NonActorMagicTarget = 0x32,
    Unk33 = 0x33,
    ...
    Hotkey = 0x49,
    EditorRef3DData = 0x4A,
    EditorRefMoveData = 0x4B,
...
const _: () = assert!(core::mem::size_of::<ExtraDataType>() == 0x4);
