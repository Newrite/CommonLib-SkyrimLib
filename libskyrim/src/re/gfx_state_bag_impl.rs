...
pub struct GFxStateBagImpl {
    pub base: GRefCountBase<GFxStateBagImpl, { GStatGroups::kGStat_Default_Mem as u32 }>, // 00
...
inherit!(GFxStateBagImpl : GRefCountBase<GFxStateBagImpl, { GStatGroups::kGStat_Default_Mem as u32 }>, base);
