...
use crate::offsets::offsets_rtti::RTTI_VATSCameraState;
use crate::offsets::offsets_vtable::VTABLE_VATSCameraState;
use crate::re::{
...
const _: () = assert!(core::mem::size_of::<VATSCameraState>() == 0x38);

impl RttiType for VATSCameraState {
    const RTTI: VariantID = RTTI_VATSCameraState;
}

inherit!(VATSCameraState : TESCameraState, base);

impl VATSCameraState {
